...
if(isset($_GET['del_id'])){
    $sql="DELETE from adoptdata where id=?";
    ...
    <section class="py-5">
        <div class="container">
            <div row="row">
                <div class=col-md-12>
                    <div class="card">
                        <h5 class="card-header text-center">Manage adoption</h5>
                        <div class="card-body">
                            <form class="" action="" method="POST" enctype="multipart/form-data">
                                <?php 
                                
                                    $sql="SELECT * FROM adoptdata where id=?";
                                    $stmt= $conn->prepare($sql);
                                ...
                                <div class="container">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="contact">Relation with child :</label>
                                                <input type="contact" class="form-control" name="relation"
                                                    value="<?php echo $key['relation'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="a_status" id="male"
                                                    value="adopted">
                                                <label class="form-check-label" for="adopted">Adopted</label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="a_status" id="female"
                                                    value="In process">
                                                <label class="form-check-label" for="female">In process</label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="a_status" id="other"
                                                    value="Not adopted">
                                    ...
                                    <button type="submit" name="edit_adpt" class="btn btn-primary ">
                                        Update</button>
                                    <?php
                                    }
                            ?>
