                ...
                <div class="position-sticky">
                    ...
                    <li class="nav-item pt-2" >
                            <a class="nav-link active" aria-current="page" data-bs-toggle="collapse"
                                href="#submenu5"><h6>Child Management</h6></a>
                        ...
                        <li class="nav-item py-2" >
                            <a class="nav-link active" aria-current="page" data-bs-toggle="collapse"
                                href="#submenu1"><h6>Caregiver's Management</h6></a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" data-bs-toggle="collapse"
                                href="#submenu2"><h6>Adoption Request</h6></a>
                            <div class="collapse" id="submenu2">
                                <ul class="list-unstyled">
                                    <li><a class="nav-link" href="adoption.php">Display</a></li>
                                    <li><a class="nav-link" href="adoption-add.php">Add</a></li>
                                    <!-- Add more subtasks as needed -->
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item py-2">
                            <a class="nav-link active" aria-current="page" data-bs-toggle="collapse"
                                href="#submenu3"><h6>Expense Tracking</h6></a>
                        ...
                        <div class="card-body">
                            <table class=" table table-bordered display">
                                ...
                                <tr>
                                       ...
                                       <td><?php echo $key['a_status'];?></td>
                                        
                                        <td>
                                            <a href="adoption-edit.php?edit_id=<?php echo $key['id'];?>"
                                                class="btn btn-primary btn-sm"><i
                                                    class="fa-regular fa-pen-to-square"></i></a>
                                            <a href="adoption-edit.php?del_id=<?php echo $key['id'];?>" 
