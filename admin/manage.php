    ...
    <section class="py-5">
        <div class="container">
            <div row="row">
                <div class=col-md-12>
                    <div class="card">
                        <h5 class="card-header text-center">Manage Child</h5>
                        <div class="card-body">
                            <table class=" table table-bordered display">
                                ...
                                <tr>
                                       ...
                                       <td><?php echo $key['status'];?></td>
                                        ...
                                        <td>
                                            <a href="child-edit.php?edit_id=<?php echo $key['id'];?>"
                                                class="btn btn-primary btn-sm"><i
                                                    class="fa-regular fa-pen-to-square"></i></a>
                                            <a href="manage.php?del_id=<?php echo $key['id'];?>" 
