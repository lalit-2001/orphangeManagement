    ...
    <section class="py-5">
        <div class="container">
            <div row="row">
                <div class=col-md-12>
                    <div class="card">
                        <h5 class="card-header text-center">Expenses Details</h5>
                        <div class="card-body">
                            <table class=" table table-bordered display">
                                ...
                                <tr>
                                        <td><?php echo $key['e_type'];?></td>
                                        <td><?php echo $key['amount'];?></td>
                                       <td><?php echo $key['date'];?></td>
                                        
                                        <td>
                                            <a href="expenses-edit.php?edit_id=<?php echo $key['id'];?>"
                                                class="btn btn-primary btn-sm"><i
                                                    class="fa-regular fa-pen-to-square"></i></a>
                                            <a href="expenses-edit.php?del_id=<?php echo $key['id'];?>" 
